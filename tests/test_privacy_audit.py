...
def test_current_version_and_native_assets_match():
    ...
    assert '"version": "0.21.0.0"' in manifest
    assert "app-v021000-197f97c6.js" in index
    assert "style-v021000-197f97c6.css" in index
    assert "panel-v021000-197f97c6.js" in panel
...
def test_release_does_not_ship_stale_versioned_frontend_bundles():
    ...
    assert [p.name for p in static.glob("app-v*.js")] == ["app-v021000-197f97c6.js"]
    assert [p.name for p in static.glob("style-v*.css")] == ["style-v021000-197f97c6.css"]
