...
def test_current_version_and_native_assets_match():
    ...
    assert '"version": "0.21.0.2"' in manifest
    assert "app-v021002-81aa3197.js" in index
    assert "style-v021002-81aa3197.css" in index
    assert "panel-v021002-81aa3197.js" in panel
...
def test_release_does_not_ship_stale_versioned_frontend_bundles():
    ...
    assert [p.name for p in static.glob("app-v*.js")] == ["app-v021002-81aa3197.js"]
    assert [p.name for p in static.glob("style-v*.css")] == ["style-v021002-81aa3197.css"]
