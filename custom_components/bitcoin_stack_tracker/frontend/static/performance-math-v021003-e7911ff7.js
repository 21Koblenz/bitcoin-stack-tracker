(function (root, factory) {
  ...
  function bisectRoot(flows, left, right, tolerance) {
    let leftValue = xnpv(left, flows);
    let rightValue = xnpv(right, flows);
  ...
  function maximumDrawdown(points) {
    const clean = normalizePricePoints(points);
