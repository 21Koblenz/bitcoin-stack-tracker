...
const BUILD_VERSION = "0.21.0.7";
const FRONTEND_BUILD = "021007-050b734c";
...
function renderFeeAnalytics(currency){
  ...
  element.innerHTML=[
    analysisCard(t("totalFees"),fmtFiat(Number(fees.total_fiat||0),currency),`${esc(t("feeRatio"))}: ${privateHtml(`${fmtNumber(Number(fees.ratio_percent||0),3)} %`)}${includedHint}`),
